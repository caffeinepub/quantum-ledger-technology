...
export default function App() {
  const _actor = useActor(); // reserved for future use
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const subject = encodeURIComponent(
        `QLT Investor Inquiry - ${formData.name}`,
      );
      const body = encodeURIComponent(
        `Name: ${formData.name}\nEmail: ${formData.email}\nCompany/Fund: ${formData.company}\nInterest Level: ${formData.interestLevel}\nMessage: ${textarea}`,
      );
      window.location.href = `mailto:info@qlt.ltd?subject=${subject}&body=${body}`;
    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <a
                href="https://qloudtechnologies.com/publications/"
                target="_blank"
                rel="noopener noreferrer"
                data-ocid="nav.primary_button"
                className="text-sm px-4 py-2 rounded-lg font-medium inline-flex items-center"
                style={{
        ...
        {mobileOpen && (
          <div className="md:hidden bg-black/95 border-t border-white/10 px-4 py-4 space-y-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
              data-ocid="nav.primary_button"
              className="w-full block text-center py-2 rounded-lg font-medium"
              style={{
                background: "linear-gradient(135deg, #0ea5e9, #7c3aed)",
                color: "white",
                textDecoration: "none",
      ...
      >
        ...
        <div className="relative z-[3] max-w-5xl mx-auto px-4 text-center">
          ...
          >
            ...
            <br />
            <span className="gradient-text">for the Future of DeFi</span>
          </h1>
          ...
          >
            ...
            <a
              ...
              className="px-8 py-3 rounded-lg font-semibold text-base inline-flex items-center justify-center"
              style={{
      ...
      >
        ...
        <div className="max-w-6xl mx-auto px-4 relative">
          ...
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl sm:text-5xl font-bold text-white fade-in-up">
              Traction: <span className="gradient-text">Where we are now?</span>
            </h2>
          </div>

          {/* Cards grid with SVG connector overlay */}
          <div className="relative">
            {/* Dotted curved connector SVG */}
            <svg
              aria-hidden="true"
            ...
            >
              ...
              {/* Row 1 connector */}
              <path
                d="M 150 85 C 250 40, 350 130, 450 85 C 550 40, 650 130, 750 85"
                fill="none"
              ...
              {/* Row 2 connector */}
              <path
                d="M 150 255 C 250 210, 350 300, 450 255 C 550 210, 650 300, 750 255"
                fill="none"
                stroke="url(#connectorGrad)"
                strokeWidth="2"
                strokeDasharray="6,5"
              ...
              <path
                d="M 450 110 C 480 160, 420 190, 450 220"
                fill="none"
                stroke="url(#connectorGrad)"
                strokeWidth="1.5"
                strokeDasharray="4,4"
            ...
            >
              {[
                ...
                },
                {
                  ...
                  label: "Countries",
                  gradient:
                    "linear-gradient(135deg, rgba(99,102,241,0.18) 0%, rgba(99,102,241,0.04) 100%)",
                  border: "rgba(99,102,241,0.35)",
                  color: "#818cf8",
                },
                {
                  stat: "7",
                  label: "European Cybersecurity Centers of Excellence",
                  gradient:
                    "linear-gradient(135deg, rgba(168,85,247,0.18) 0%, rgba(168,85,247,0.04) 100%)",
                ...
                },
                {
                  ...
                  gradient:
                    "linear-gradient(135deg, rgba(0,245,255,0.15) 0%, rgba(0,245,255,0.03) 100%)",
                ...
                },
                {
                  ...
                  gradient:
                    "linear-gradient(135deg, rgba(56,189,248,0.18) 0%, rgba(56,189,248,0.04) 100%)",
                  border: "rgba(56,189,248,0.3)",
                  color: "#38bdf8",
                },
                {
                  stat: "Seal of Excellence",
                ...
                <div
                  key={item.label}
                  className="fade-in-up rounded-2xl p-7 flex flex-col items-center text-center"
                  style={{
                    background: item.gradient,
                    border: `1px solid ${item.border}`,
                    boxShadow: `0 8px 32px rgba(0,0,0,0.35), 0 0 0 1px ${item.border}`,
                    backdropFilter: "blur(12px)",
                    transitionDelay: `${i * 0.08}s`,
                  }}
                  data-ocid={`traction.card.${i + 1}`}
                >
                  {item.isSeal ? (
                    <>
                      <div
                  ...
                  <div className="text-gray-200 font-medium text-sm leading-snug mt-1">
                    {item.label}
                  </div>
                </div>
              ))}
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              {
                name: "Asad Khan",
                title: "Head Business Dev",
                bio: "Dynamic professional with over 15 years of experience in sales, marketing and relationship management in B2C, B2B for corporate & government",
                initials: "AK",
        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          >
            ...
            <span className="text-white font-bold">
              $1M in strategic seed investment
            </span>{" "}
