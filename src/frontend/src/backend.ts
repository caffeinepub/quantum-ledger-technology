...
export class Backend implements backendInterface {
    ...
    async findLeadsByCompany(arg0: string): Promise<Array<Lead>> {
        if (this.processError) {
            try {
                const result = await this.actor.findLeadsByCompany(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async findLeadsByInterestLevel(arg0: string): Promise<Array<Lead>> {
        if (this.processError) {
            try {
                const result = await this.actor.findLeadsByInterestLevel(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLeadsSortedByTimestamp(): Promise<Array<Lead>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLeadsSortedByTimestamp();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
